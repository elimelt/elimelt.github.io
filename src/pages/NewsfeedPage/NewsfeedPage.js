...
const NewsfeedPage = () => {
  ...
  const samplePosts = [
    { timestamp: "2 hours ago", subject: "First Post", content: "This is my first post on the feed!" },
    { timestamp: "1 hour ago", subject: "Second Post", content: "Another post for the feed." },
  ];
